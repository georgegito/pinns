...
v_wing = [v(t, x, y, z) for (x, y, z) in zip(x_wing, y_wing, z_wing)]

# ╔═╡ 73d3a941-686e-4d4f-94c4-ea25ae741e87
w_wing = [w(t, x, y, z) for (x, y, z) in zip(x_wing, y_wing, z_wing)]
...
git-tree-sha1 = "75e3b3732929e880e7fd121e8a4e4dd5e1bfeaee"
