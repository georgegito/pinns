...
## F1 Car Front Wing Aerodymanics
"""
...
begin
	min = minimum(minimum.(eachcol(u_sampled_df[!, 1:3])))
	max = maximum(maximum.(eachcol(u_sampled_df[!, 1:3])))
	range = (min, max)
end
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "ac67d8f2b02f3bffea0f531aa75eacfdcf26bdf1"
