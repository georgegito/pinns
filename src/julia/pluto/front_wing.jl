...
load("/Users/ggito/repos/pinns/src/julia/f1_front_wing/images/wing.PNG")  # Replace with your image path
...
begin
	...
	@bind num_of_samples html"<input type=range min=1000 max=200000 step=10000 value=10000>"
end
...
indices = sample(1:total_points, num_of_samples, replace=false)
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "c3073828acc41842fde39cb3c70b3c2551839c3f"
...
git-tree-sha1 = "07b0cdd9011e26c8eaea6a62c0507b7f2c52a0bf"
...
git-tree-sha1 = "b7b95e8ff67c769b4d899e18bebdb81f9337d3df"
