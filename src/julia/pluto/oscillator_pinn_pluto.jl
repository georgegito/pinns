...
# ╔═╡ f6513390-e529-11ed-0c74-f966db506598
begin
	using NeuralPDE
	using LinearAlgebra
	using Plots
...
# ╔═╡ f02550da-ec36-4455-a8fd-d912babd7140
md"""
# Mass-Spring Underdamped Oscillator
"""

# ╔═╡ 07e5fd10-06ca-4c82-925f-3053907bfda1
md"""
...
# ╔═╡ dd0c091f-8be7-44af-a90f-88488adc039f
begin
	@parameters t
	@variables y(..)
	Dt = Differential(t)
...
# ╔═╡ c2f7ad73-c417-4986-9cac-e40884883541
use_gpu = false

# ╔═╡ 65afbe42-9644-4451-a828-0f0ab7360bd5
begin	
...
# ╔═╡ bbce7f02-24f4-4ec8-a16c-105a68c66d82
begin
	...
	p2 = plot(t_real, y_real, xlabel="t", ylabel="y", label="Real system output", linewidth=:1.5)
	p2 = scatter!(t_u, y_u, label="Training points")

end

# ╔═╡ a7e2fab5-19cd-44f2-9c0b-e9a16af37675
begin
	# ODE
...
# ╔═╡ a0e1fdc5-c16c-4123-b141-332041ce1b48
res = @time Optimization.solve(prob, opt; callback=callback, maxiters=1000)

# ╔═╡ cecdad33-960d-42de-bdfb-b393a7cced0d
begin
...
# ╔═╡ a9f5bfbd-d113-4976-8a14-bc9b2ad652a2
begin
	p3 = plot(t_real, y_real, xlabel="t", ylabel="y", label="Real system output", linewidth=:1.8)
	p3 = scatter!(t_u, y_u, label="Training points")
	p3 = plot!(t_span, y_predict, xlabel="t", ylabel="y", label="PINN prediction", linewidth=:1.2, linecolor=:red, linestyle=:dot)
end
...
git-tree-sha1 = "91c7576ada99d4ec401afcd6d75873ede2273061"
