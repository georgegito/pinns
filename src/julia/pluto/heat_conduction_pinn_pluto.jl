...
# ╔═╡ 070ed6b0-e52f-11ed-2f66-e185dacfb061
begin
...
# ╔═╡ 31f68e7a-e032-40f3-ad7d-4060432776d3
using Plots

# ╔═╡ 7fb785ae-7024-41ac-84fe-391bc7057823
md"""
# Unsteady Heat Conduction Equation
"""

# ╔═╡ 906bbf85-14e0-4075-bac9-839a27cd5437
md"""
$$\frac{\partial T(x,t)}{\partial t} = \alpha \frac{\partial^2 T(x,t)}{\partial x^2}$$
"""

# ╔═╡ 315bce60-60ba-49bf-8332-de3bb3d294be
use_gpu = false

# ╔═╡ e00b860e-9581-4192-9b41-7a8f1500b667
begin
	@parameters t, x
	@variables u(..)
...
# ╔═╡ 334d67aa-de70-48f6-bed1-9d6309470457
begin
...
# ╔═╡ 0fc7bd1c-1f0a-46ac-a12a-fe8e2204b170
begin
	# Neural network
	hidden_size = 16
...
# ╔═╡ a59ee7c9-4293-4ce5-88b2-e378af1bad9d
@named pde_system = PDESystem(eq, bcs, domains, [t, x], [u(t, x)])

# ╔═╡ c18f1b30-ddb1-450c-8ba4-ea5a2b62a0fe
begin
...
# ╔═╡ bb474032-446f-4fc9-a6e2-6d39a34b464d
begin
...
# ╔═╡ b63461dc-21f6-415f-9db6-2a8016423c34
begin
...
# ╔═╡ fdb8b506-026f-4aba-ac2c-ff95ac95530b
begin
