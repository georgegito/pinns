...
# ╔═╡ 08942190-df65-11ed-37fa-0341a4ac132f
using NeuralPDE, Lux, Optimization, OptimizationOptimJL

# ╔═╡ 81a0aae4-a21e-48d3-9ad0-a14ff896f134
using Plots

# ╔═╡ d864ebb1-a553-440f-8256-d5c4300d1fbe
# using CUDA, Random, ComponentArrays
import ModelingToolkit: Interval

# ╔═╡ 949a923c-be2f-4e7f-b626-a1d54f3eb7e4
begin
	@parameters t, x
	@variables u(..)
...
# ╔═╡ d3c39061-d76d-4810-ae41-35cb65175dda
begin
	#PDE
	alpha = 1
...
# ╔═╡ 5c719216-14ad-4aee-9f15-c1fcf48959b2
begin
	#Neural network
	hidden_size = 16
	chain = Lux.Chain(Dense(2, hidden_size, Lux.σ), Dense(hidden_size, hidden_size, Lux.σ), Dense(hidden_size, 1))
	# chain = Lux.Chain(Dense(2, 64, Lux.σ), Dense(64, 64, Lux.σ), Dense(64, 64, Lux.σ), Dense(64, 64, Lux.σ), Dense(64, 1))
...
# ╔═╡ 86446975-14dd-41ce-82e8-ecdf48bc5560
begin
	# optimizer
	opt = OptimizationOptimJL.BFGS()
	res = @time Optimization.solve(prob, opt; callback = callback, maxiters = 1200)
	phi = discretization.phi
end

# ╔═╡ 40feb37f-457e-4a09-8f7d-f579114c39c8
begin
	...
	p1 = contour(xs, ts, u_real', xlabel="x", ylabel="t", title="Temperature Distribution - analytic", color=:turbo, levels=7, fill=true, lw=0)
	p2 = contour(xs, ts, u_predict', xlabel="x", ylabel="t", title="Temperature Distribution - predict", color=:turbo, levels=7, fill=true, lw=0)
	
	plot(p1, p2, layout=(2, 1), size=(1000, 1000))
	# plot(p1)
end

# ╔═╡ 2ea3c811-141a-4d66-8adf-8b22fbbc90ca
# using PlutoUI

# ╔═╡ 9ff2bc97-f86b-4d65-9a2b-3e0374bab5cb
# begin
# 	a = [1, 2, 3, 4]
# 	b = [1, 2, 3, 4]
